...
def print_cell_report(cells):
    ...
    print("------------")
    for cell in cells:
        print(f"Cell ID: {cell.id:<3} Position: ({int(cell.x):<4} {int(cell.y):<3})  Type: {cell.type:<8} Energy: {cell.get_energy_level():<3}")

def print_health_report(cells):
    print("\n\nHealth Report:")
    print("--------------") 
    for cell in cells:
        print(f"Cell ID: {cell.id:<3} Type: {cell.type:<8} Energy: {cell.get_energy_level():<3}")
